...
> Diperbarui 2026-09-17. Dipakai oleh tabel anggaran BAB IV proposal
...
- **Sumber** hanya dua: RAB awal penulis, atau listing Tokopedia yang tautannya
  dicatat di sini.
- Bila ada beberapa listing, dipakai **median**.
...
|---|---|---:|---:|
| Penerima ExpressLRS EP2 TCXO | [justShopIt, Bandung](https://www.tokopedia.com/justshopit/happymodel-2-4g-expresslrs-elrs-ep2-tcxo-long-range-rc-receiver) | 203.000 | **215.000** (median) |
...
| *Stack* SpeedyBee F405 Mini + ESC BLS 35A | [justShopIt, Bandung](https://www.tokopedia.com/justshopit/speedybee-f405-mini-bls-35a-3-6s-20x20mm-stack-flight-controller-fc-esc-for-fpv-drones-dji-vista-link-air-unit-o3-esc-6a84a) | 1.275.000 | **1.906.700** (median) ⚠️ |
...
⚠️ *Stack*: selisih antarlisting besar (Rp1,28–2,24 juta). Cuplikan justShopIt yang
