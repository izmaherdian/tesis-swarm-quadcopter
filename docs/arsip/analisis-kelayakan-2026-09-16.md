...
> [`02-lab/1-ruang-uji-dan-arena.md`](../02-lab/1-ruang-uji-dan-arena.md) (ruang, arena),
> [`02-lab/2-inventaris.md`](../02-lab/2-inventaris.md) (perangkat keras), dan
> [`04-keputusan/`](../04-keputusan/) (kamera KP03, firmware KP02). Bagian kamera 4K,
...
Langkah rinci dan rencana cadangan ada di `docs/04-keputusan/KP02-firmware-fc.md`.
...
| Keputusan | Berkas |
|---|---|
| Lokalisasi: kamera atas + AprilTag, UWB opsional bersyarat | `docs/04-keputusan/KP01-lokalisasi-kamera-apriltag.md` |
| Firmware FC: ArduPilot racikan lewat Custom Firmware Builder | `docs/04-keputusan/KP02-firmware-fc.md` |
