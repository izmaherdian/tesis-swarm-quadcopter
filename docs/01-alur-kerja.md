...
|---|---|---|---|---|
| Berapa kamera dan ukuran penanda? | plafon 300 cm, segmen 7,20 × 2,70 m | lembar data ELP (foto 18), DeGol dkk. 2017 (acuan > 70 piksel), tiga makalah AprilTag | [KP03](04-keputusan/KP03-kamera-elp-lensa-2-1mm.md) | subbab liputan kamera, RAB Fase 2 dan Fase 4 |
...
| **4** Uji Terbang Eksperimen | Des–Apr | naik bertahap 1 → 3 → 5 wahana ([KP06](04-keputusan/KP06-bentuk-evaluasi-dan-hipotesa.md)). (a) tunggal, yaitu EKF, tautan, PID, ERC agen tunggal, deteksi penanda saat bergerak; (b) tiga wahana; (c) lima wahana. Tiap tahap kawanan menjalankan kondisi kontrol formasi V di koridor terbuka lalu kondisi uji ERC melintasi celah, 10 lintasan tiap kondisi | **gerbang 2** hover 60 s simpangan RMS ≤ 0,10 m dan penanda terdeteksi ≥ 95% bingkai; **gerbang 3** tiga wahana, ≥ 8 dari 10 lintasan berhasil dan jarak antaragen ≥ 0,30 m; **gerbang 4** kriteria sama pada lima wahana | tiga tabel, yaitu Rp113.220 sebelum uji tunggal, Rp10.242.427 setelah gerbang 2 (tiga wahana dan arena), Rp3.001.500 setelah gerbang 3 (lima wahana) |
