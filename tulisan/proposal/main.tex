...
Wahana eksperimental yang digunakan adalah quadcopter konfigurasi tipe `X' berbasis platform SpeedyBee Bee35, kelanjutan dari arsitektur fisik pada penelitian sebelumnya \cite{argilianaPengembanganSistemKontrol2025} yang ditingkatkan untuk mendukung komputasi kontrol desentralisasi penuh di atas wahana (\textit{on-board}). Arsitektur fisiknya terdiri atas struktur mekanik, sistem propulsi, sistem kontrol terbang, sistem komputasi tingkat tinggi, subsistem daya, dan jalur komunikasi antarkomponen.
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|c|X|>{\centering\arraybackslash}p{1.8cm}|>{\raggedleft\arraybackslash}p{2.3cm}|>{\raggedleft\arraybackslash}p{2.3cm}|}
        ...
        3 & Pemancar dan penerima kendali radio & 1 set & \textit{survei} & \textit{survei} \\ \hline
        4 & Sensor ultrasonik HC-SR04 (kandidat A) & 2 unit & 20.000 & 40.000 \\ \hline
        5 & Sensor jarak laser VL53L1X (kandidat B) & 2 unit & \textit{survei} & \textit{survei} \\ \hline
        6 & Penanda \textit{AprilTag}, akrilik, dan tiang cetak tiga dimensi & 1 set & 20.000 & 20.000 \\ \hline
