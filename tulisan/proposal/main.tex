...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|c|>{\raggedright\arraybackslash}X|>{\centering\arraybackslash}p{1.35cm}|>{\raggedleft\arraybackslash}p{2.1cm}|>{\raggedleft\arraybackslash}p{2.8cm}|}
        ...
        \multicolumn{4}{|r|}{\textbf{Subtotal}} & \textbf{14.181.427} \\ \hline
    \end{tabularx}
    \endgroup
\end{table}
...
Rencana Anggaran Biaya (RAB\label{abbr:rab}) dirangkum pada Tabel~\ref{tab:rekap_rab}. Perlengkapan keselamatan masih memakai nilai RAB awal penulis, sedangkan pos lain pada Tabel~\ref{tab:rab_fase2} dan Tabel~\ref{tab:rab_fase4} mengacu pada listing Tokopedia yang tautannya tercantum di bawah nama komponen (diakses 17 September 2026). Tiang penyangga penanda dicetak dengan pencetak tiga dimensi yang tersedia sehingga tidak dianggarkan. Bila terdapat beberapa listing untuk produk yang sama, dipakai harga tertinggi. Penjual kamera mengonfirmasi bahwa lensa $2{,}1$~mm tersedia dengan harga yang sama melalui pra-pesan selama tiga minggu, sehingga kamera pertama dipesan pada Fase~1 dan kamera kedua dipesan segera setelah uji terbang tunggal lolos.
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|X|>{\raggedleft\arraybackslash}p{4.0cm}|}
        ...
        Fase 4: Uji Terbang Eksperimen & 14.181.427 \\ \hline
        Fase 5: Analisis Data dan Pelaporan & -- \\ \hline
        \textbf{Total} & \textbf{24.227.654} \\ \hline
    \end{tabularx}
    \endgroup
\end{table}
