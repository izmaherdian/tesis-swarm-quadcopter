...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|c|X|>{\centering\arraybackslash}p{1.35cm}|>{\raggedleft\arraybackslash}p{2.1cm}|>{\raggedleft\arraybackslash}p{2.8cm}|}
        ...
        \multicolumn{4}{|r|}{\textbf{Subtotal}} & \textbf{6.532.856 + \textit{survei}} \\ \hline
    \end{tabularx}
    \endgroup
\end{table}
...
Rencana Anggaran Biaya (RAB\label{abbr:rab}) dirangkum pada Tabel~\ref{tab:rekap_rab}. Harga bersumber dari RAB awal penulis dan survei Tokopedia pada September 2026. Bila terdapat beberapa listing, dipakai harga tertinggi. Pos bertanda \textit{survei} belum memiliki harga dan tidak diperkirakan.
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|l|>{\raggedleft\arraybackslash}p{3.0cm}|X|}
        ...
        Fase 4: Uji Terbang Eksperimen & 6.532.856 & kamera kedua, sensor jarak terpilih, lakban \\ \hline
        Fase 5: Analisis Data dan Pelaporan & -- & -- \\ \hline
        \textbf{Total} & \textbf{7.892.856} & \\ \hline
    \end{tabularx}
    \endgroup
\end{table}
