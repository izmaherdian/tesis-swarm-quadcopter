...
Bab~III Perancangan Sistem memuat kondisi awal perangkat, arsitektur wahana, rancangan sistem lokalisasi dan persepsi rintangan, rancangan estimator dan pengendali, rancangan arena uji, serta arsitektur sistem menyeluruh.
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|c|>{\raggedright\arraybackslash}p{3.6cm}|>{\raggedright\arraybackslash}X|>{\centering\arraybackslash}p{1.6cm}|}
        ...
        6 & Penerima kendali radio ExpressLRS & 2,4 GHz (EP2 TCXO dan modul berbasis ESP8285); 4 terpasang, 1 lepas; pemancar belum tersedia & 5 unit \\ \hline
        ...
        14 & Komputer stasiun darat dan penghala Wi-Fi khusus & Laptop Lenovo AMD Ryzen 5 4500U (6 inti), memori 14 GiB, Ubuntu 26.04, dua pengendali USB 3.1; model penghala belum dicatat & tersedia \\ \hline
    \end{tabularx}
    \endgroup
\end{table}
