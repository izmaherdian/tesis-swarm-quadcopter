...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|c|>{\raggedright\arraybackslash}p{3.6cm}|>{\raggedright\arraybackslash}X|>{\centering\arraybackslash}p{1.6cm}|}
        ...
        3 & \textit{Flight controller} SpeedyBee F405 Mini & Mikrokontroler STM32F405 (\textit{flash} 1 MB), IMU ICM-42688P, barometer DSP-310 & 3 unit \\ \hline
        4 & ESC SpeedyBee BLS 35A Mini & 4-in-1, firmware BLHeli\_S & 3 unit \\ \hline
        5 & \textit{Companion computer} Seeed XIAO ESP32-S3 & Wi-Fi 2,4 GHz dan BLE terintegrasi, antarmuka USB-C & 3 unit \\ \hline
        ...
        11 & Pengisi daya baterai, kontainer penyimpanan baterai, komputer stasiun darat, dan penghala Wi-Fi khusus & Perangkat pendukung di sisi darat & tersedia \\ \hline
    \end{tabularx}
    \endgroup
\end{table}
...
\begin{enumerate}
    ...
    \item \textbf{Uji terbang kawanan.} Kamera kedua dipasang dan kedua kamera dikalibrasi ke satu kerangka acuan global. Inventaris (Tabel~\ref{tab:komponen_tersedia}) memuat tiga \textit{flight controller}, tiga ESC, dan tiga \textit{companion computer}, sehingga dua set untuk wahana keempat dan kelima dilengkapi pada tahap ini. Kelima wahana lebih dahulu terbang dalam formasi V di ruang terbuka sebagai acuan, kemudian melintasi arena (Subbab~\ref{sec:arena}). Lebar ruang $w_e$ yang turun melewati ambang memicu ERC sehingga formasi menyusut, beralih mengekor melalui celah $90$~cm, lalu mengembang kembali.
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|c|>{\raggedright\arraybackslash}X|>{\centering\arraybackslash}p{1.35cm}|>{\raggedleft\arraybackslash}p{2.1cm}|>{\raggedleft\arraybackslash}p{2.8cm}|}
        ...
        7 & Penerima ExpressLRS EP2 TCXO\newline{\footnotesize\href{https://www.tokopedia.com/sabinar/terbaru-happymodel-2-4g-expresslrs-elrs-ep2-tcxo-long-range-rc-receiver-terlaris-1731126126732018778}{tokopedia.com/sabinar}} & 2 unit & 337.000 & 674.000 \\ \hline
        8 & \textit{Stack} SpeedyBee F405 Mini dan ESC BLS 35A\newline{\footnotesize\href{https://www.tokopedia.com/lapakfianprasetyo/speedybee-f405-mini-bls-35a-20x20-stack-f405-flight-controller-35}{tokopedia.com/lapakfianprasetyo}} & 2 set & 1.906.700 & 3.813.400 \\ \hline
        9 & \textit{Companion computer} Seeed XIAO ESP32-S3\newline{\footnotesize\href{https://www.tokopedia.com/cncstorebandung/xiao-esp32s3-original-board-iot-development-kit-dual-core-wifi-bluetooth-5-0-ble-microcontroller-1732253317634623038}{tokopedia.com/cncstorebandung}} & 2 unit & 282.500 & 565.000 \\ \hline
        10 & Kardus polos 60 $\times$ 40 $\times$ 40 cm sebagai rintangan\newline{\footnotesize\href{https://www.tokopedia.com/berlian90/dus-packing-polos-jumbo-60x40x40-cm-kardus-besar-kardus-packing-polos-box-jumbo-kondisi-baru-1730914591889655635}{tokopedia.com/berlian90}} & 10 unit & 34.700 & 347.000 \\ \hline
        11 & Lakban lantai vinil 3M 764, 2 inci $\times$ 33 m\newline{\footnotesize\href{https://www.tokopedia.com/dewielectrical/3m-lakban-lantai-3m-764-vinyl-floor-marking-tape-2-x33-m-hitam}{tokopedia.com/dewielectrical}} & 1 rol & 55.000 & 55.000 \\ \hline
        \multicolumn{4}{|r|}{\textbf{Subtotal}} & \textbf{13.794.647} \\ \hline
    \end{tabularx}
    \endgroup
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|X|>{\raggedleft\arraybackslash}p{4.0cm}|}
        ...
        Fase 4: Uji Terbang Eksperimen & 13.794.647 \\ \hline
        Fase 5: Analisis Data dan Pelaporan & -- \\ \hline
        \textbf{Total} & \textbf{23.840.874} \\ \hline
    \end{tabularx}
    \endgroup
\end{table}
