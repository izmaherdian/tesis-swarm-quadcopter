...
Rencana Anggaran Biaya (RAB\label{abbr:rab}) dirangkum pada Tabel~\ref{tab:rekap_rab}. Pos yang tidak bertautan pada Tabel~\ref{tab:rab_fase2} dan Tabel~\ref{tab:rab_fase4} berasal dari RAB awal penulis, sedangkan pos bertautan mengacu pada listing Tokopedia yang diakses 17 September 2026. Bila terdapat beberapa listing untuk produk yang sama, dipakai harga tertinggi. Penjual kamera mengonfirmasi bahwa lensa $2{,}1$~mm tersedia dengan harga yang sama melalui pra-pesan selama tiga minggu, sehingga kamera pertama dipesan pada Fase~1 dan kamera kedua dipesan segera setelah uji terbang tunggal lolos.
