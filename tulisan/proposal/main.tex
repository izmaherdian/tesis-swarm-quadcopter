...
Rincian alat, bahan, kuantitas, serta estimasi biaya pengadaan komponen utama penelitian dirangkum dalam bentuk Rencana Anggaran Biaya (RAB\label{abbr:rab}) pada Tabel~\ref{tab:alat_bahan}.
...
\subsection{Biaya}
Berdasarkan kebutuhan alat dan bahan yang telah diidentifikasi pada Tabel~\ref{tab:alat_bahan}, total estimasi biaya pengadaan komponen tambahan penelitian adalah sebesar Rp2.750.000. Porsi biaya terbesar berasal dari pengadaan kamera atas 60 FPS beserta perlengkapan pemasangannya, yaitu sebesar Rp1.650.000 atau sekitar 60\% dari total anggaran. Perangkat tersebut dibutuhkan sebagai sumber acuan posisi absolut bagi seluruh agen quadcopter dalam kerangka acuan global. Komponen lain, seperti sensor ultrasonik, penanda visual \textit{AprilTag}, dus sebagai rintangan, dan perlengkapan keselamatan, digunakan untuk mendukung pengujian persepsi lingkungan serta menjaga keamanan selama eksperimen berlangsung.
