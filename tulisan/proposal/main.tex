...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|c|>{\raggedright\arraybackslash}p{3.6cm}|>{\raggedright\arraybackslash}X|>{\centering\arraybackslash}p{1.6cm}|}
        ...
        9 & Propeler Gemfan 90 mm dan cadangan saluran & Propeler tiga bilah; dua paket pelindung dan penyangga saluran & 14 unit \\ \hline
        ...
        13 & Perlengkapan pengisian baterai & Papan pengisian paralel Power Genius 2--6S, SkyRC \textit{multi balance board}, kontainer penyimpanan baterai & tersedia \\ \hline
