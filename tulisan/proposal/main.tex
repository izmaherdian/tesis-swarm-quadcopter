...
Tata letak arena selengkapnya diperlihatkan pada Gambar~\ref{fig:sketsa_arena}. Salah satu kolom bangunan yang menjorok ke koridor menjadi satu sisi penyempitan karena posisinya permanen, sehingga geometri rintangan dapat direproduksi antarsesi tanpa pengukuran ulang. Sisi seberangnya dilengkapi susunan dus kardus yang menjorok sedalam $1{,}01$ m sehingga menyisakan celah $90$ cm. Dus berukuran $60 \times 40 \times 40$ cm disusun dua baris sehingga kedalamannya $1{,}00$ m, dan ditumpuk empat lapis sehingga tingginya $1{,}60$ m, yaitu di atas ketinggian terbang agar berkas sensor jarak mengenai dinding rintangan dan tidak ada rongga di belakangnya pada ketinggian tersebut. Susunan itu menuntut $32$ dus, yang menjadi dasar jumlah pada Tabel~\ref{tab:rab_fase4}.
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|X|>{\raggedleft\arraybackslash}p{4.0cm}|}
        ...
        Fase 4: Uji Terbang Eksperimen & 13.357.147 \\ \hline
