...
Rencana Anggaran Biaya (RAB\label{abbr:rab}) dirangkum pada Tabel~\ref{tab:rekap_rab}. Seluruh pos pada Tabel~\ref{tab:rab_fase2} dan Tabel~\ref{tab:rab_fase4} mengacu pada listing Tokopedia yang tautannya tercantum di bawah nama komponen (diakses 17 September 2026). Tiang penyangga penanda dicetak dengan pencetak tiga dimensi yang tersedia, dan baterai disimpan dalam kontainer baterai milik laboratorium, sehingga keduanya tidak dianggarkan. Bila terdapat beberapa listing untuk produk yang sama, dipakai harga tertinggi. Penjual kamera mengonfirmasi bahwa lensa $2{,}1$~mm tersedia dengan harga yang sama melalui pra-pesan selama tiga minggu, sehingga kamera pertama dipesan pada Fase~1 dan kamera kedua dipesan segera setelah uji terbang tunggal lolos.
