...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|c|X|>{\centering\arraybackslash}p{1.35cm}|>{\raggedleft\arraybackslash}p{2.1cm}|>{\raggedleft\arraybackslash}p{2.8cm}|}
        ...
        1 & Kamera ELP-U3GS05B10C-IB21 (5 MP \textit{global shutter}, lensa 2,1 mm) & 1 unit & 6.600.000 & 6.600.000 \\ \hline
        2 & Kabel USB ekstensi 10 m dan dudukan langit-langit & 1 set & 150.000 & 150.000 \\ \hline
        3 & Pemancar ExpressLRS 2,4 GHz RadioMaster Pocket & 1 unit & 2.339.000 & 2.339.000 \\ \hline
        4 & Sensor ultrasonik HC-SR04 (kandidat) & 2 unit & 20.000 & 40.000 \\ \hline
        5 & Sensor jarak laser VL53L1X (kandidat) & 2 unit & 98.500 & 197.000 \\ \hline
        6 & Penanda AprilTag, akrilik, dan tiang cetak tiga dimensi & 1 set & 20.000 & 20.000 \\ \hline
        \multicolumn{4}{|r|}{\textbf{Subtotal}} & \textbf{9.346.000} \\ \hline
    \end{tabularx}
    \endgroup
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|c|X|>{\centering\arraybackslash}p{1.35cm}|>{\raggedleft\arraybackslash}p{2.1cm}|>{\raggedleft\arraybackslash}p{2.8cm}|}
        ...
        2 & Kamera ELP-U3GS05B10C-IB21 kedua & 1 unit & 6.600.000 & 6.600.000 \\ \hline
        3 & Kabel USB ekstensi 10 m dan dudukan langit-langit & 1 set & 150.000 & 150.000 \\ \hline
        4 & Sensor jarak terpilih & 8 unit & 98.500 & 788.000 \\ \hline
        5 & Penanda AprilTag, akrilik, dan tiang cetak tiga dimensi & 4 set & 20.000 & 80.000 \\ \hline
        6 & Penerima ExpressLRS EP2 TCXO & 2 unit & 337.000 & 674.000 \\ \hline
        7 & \textit{Stack} SpeedyBee F405 Mini dan ESC BLS 35A & 2 set & 1.906.700 & 3.813.400 \\ \hline
        8 & \textit{Companion computer} Seeed XIAO ESP32-S3 & 2 unit & 282.500 & 565.000 \\ \hline
        9 & Dus kardus sebagai rintangan & 10 unit & 30.000 & 300.000 \\ \hline
        10 & Lakban lantai vinil 3M 764, 2 inci $\times$ 33 m & 1 rol & 55.000 & 55.000 \\ \hline
        \multicolumn{4}{|r|}{\textbf{Subtotal}} & \textbf{13.525.400} \\ \hline
    \end{tabularx}
    \endgroup
\end{table}

Pos sensor jarak terpilih memakai harga VL53L1X sebagai batas atas; bila HC-SR04 yang terpilih, pos tersebut turun menjadi Rp160.000.
...
Rencana Anggaran Biaya (RAB\label{abbr:rab}) dirangkum pada Tabel~\ref{tab:rekap_rab}. Harga bersumber dari RAB awal penulis dan survei Tokopedia pada September 2026. Bila terdapat beberapa listing, dipakai harga tertinggi. Penjual kamera mengonfirmasi bahwa lensa $2{,}1$~mm tersedia dengan harga yang sama melalui pra-pesan selama tiga minggu, sehingga kamera pertama dipesan pada Fase~1 dan kamera kedua dipesan segera setelah uji terbang tunggal lolos.
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|X|>{\raggedleft\arraybackslash}p{4.0cm}|}
        ...
        Fase 2: Implementasi Teknologi & 9.346.000 \\ \hline
        Fase 3: Pengujian HITL & -- \\ \hline
        Fase 4: Uji Terbang Eksperimen & 13.525.400 \\ \hline
        Fase 5: Analisis Data dan Pelaporan & -- \\ \hline
        \textbf{Total} & \textbf{22.871.400} \\ \hline
    \end{tabularx}
    \endgroup
\end{table}

Harga dari RAB awal penulis mencakup kabel USB ekstensi dan dudukan, HC-SR04, penanda, dus, dan perlengkapan keselamatan. Pos lainnya mengacu pada listing Tokopedia yang dirangkum pada Tabel~\ref{tab:sumber_harga} (diakses 17 September 2026).

\begin{table}[htbp]
    \centering
    \caption{Sumber harga dari Tokopedia}
    \label{tab:sumber_harga}
    \begingroup
    \footnotesize
    \setlength{\tabcolsep}{3pt}
    \renewcommand{\arraystretch}{1.3}
    \begin{tabularx}{\textwidth}{|c|>{\raggedright\arraybackslash}p{3.4cm}|>{\raggedright\arraybackslash}p{2.2cm}|>{\raggedright\arraybackslash}X|}
        \hline
        \rowcolor{gray!20}
        \thead{No} & \thead{Komponen} & \thead{Toko} & \thead{Tautan listing} \\ \hline
        1 & Kamera ELP-U3GS05B10C-IB21 & Fast Importir & \url{https://www.tokopedia.com/inithriftshop/elp-5mp-global-shutter-color-usb3-0-camera-og05b10-60fps-2592x1944-high-speed-camera-with-3-6-10mm-manual-vafifocus-cs-lens-1736975155939870122} \\ \hline
        2 & Pemancar RadioMaster Pocket ELRS & Dunia Fantasiku & \url{https://www.tokopedia.com/dfantasiku/radiomaster-pocket-elrs-2-4ghz-radio-controller-tx-charcoal-gratis-ongkir-1730797488802858854} \\ \hline
        3 & Sensor jarak laser VL53L1X & CNC Store Bandung & \url{https://www.tokopedia.com/cncstorebandung/modul-sensor-jarak-tof200c-vl53l0x-tof400c-vl53l1x-tof050c-vl6180x-modules-distance-sersor-vl53l1x-92c0f} \\ \hline
        4 & Penerima ExpressLRS EP2 TCXO & Abadi store07 & \url{https://www.tokopedia.com/sabinar/terbaru-happymodel-2-4g-expresslrs-elrs-ep2-tcxo-long-range-rc-receiver-terlaris-1731126126732018778} \\ \hline
        5 & \textit{Stack} SpeedyBee F405 Mini dan ESC BLS 35A & Lapak Fian Prasetyo & \url{https://www.tokopedia.com/lapakfianprasetyo/speedybee-f405-mini-bls-35a-20x20-stack-f405-flight-controller-35} \\ \hline
        6 & Seeed XIAO ESP32-S3 & CNC Store Bandung & \url{https://www.tokopedia.com/cncstorebandung/xiao-esp32s3-original-board-iot-development-kit-dual-core-wifi-bluetooth-5-0-ble-microcontroller-1732253317634623038} \\ \hline
        7 & Lakban lantai vinil 3M 764 & Dewielectrical & \url{https://www.tokopedia.com/dewielectrical/3m-lakban-lantai-3m-764-vinyl-floor-marking-tape-2-x33-m-hitam} \\ \hline
    \end{tabularx}
    \endgroup
\end{table}
