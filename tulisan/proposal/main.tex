...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|c|X|>{\centering\arraybackslash}p{1.35cm}|>{\raggedleft\arraybackslash}p{2.1cm}|>{\raggedleft\arraybackslash}p{2.8cm}|}
        ...
        \multicolumn{4}{|r|}{\textbf{Subtotal}} & \textbf{8.157.000} \\ \hline
    \end{tabularx}
    \endgroup
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|c|X|>{\centering\arraybackslash}p{1.35cm}|>{\raggedleft\arraybackslash}p{2.1cm}|>{\raggedleft\arraybackslash}p{2.8cm}|}
        ...
        6 & Penerima ExpressLRS EP2 TCXO & 2 unit & 309.000 & 618.000 \\ \hline
        7 & \textit{Stack} SpeedyBee F405 Mini dan ESC BLS 35A & 2 set & 2.244.428 & 4.488.856 \\ \hline
        8 & \textit{Companion computer} Seeed XIAO ESP32-S3 & 2 unit & 198.000 & 396.000 \\ \hline
        ...
        \multicolumn{4}{|r|}{\textbf{Subtotal}} & \textbf{13.975.856} \\ \hline
    \end{tabularx}
    \endgroup
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|X|>{\raggedleft\arraybackslash}p{4.0cm}|}
        ...
        Fase 2: Implementasi Teknologi & 8.157.000 \\ \hline
        Fase 3: Pengujian HITL & -- \\ \hline
        Fase 4: Uji Terbang Eksperimen & 13.975.856 \\ \hline
        Fase 5: Analisis Data dan Pelaporan & -- \\ \hline
        \textbf{Total} & \textbf{22.132.856} \\ \hline
    \end{tabularx}
    \endgroup
\end{table}
