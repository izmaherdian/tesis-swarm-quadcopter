...
\begin{table}[htbp]
    \centering
    \caption{Liputan satu kamera dan ukuran penanda pada ketinggian terbang $1{,}2$~m menurut model lubang jarum}
    ...
    \begin{tabularx}{\textwidth}{|X|>{\centering\arraybackslash}p{4.0cm}|}
        ...
        Liputan $w_\parallel \times w_\perp$ & $4{,}70 \times 3{,}53$ m \\ \hline
        Resolusi $\rho$ pada bidang terbang & $1{,}80$ mm/piksel \\ \hline
        Sisi penanda $10$ cm & $55$ piksel \\ \hline
        Sisi penanda $12$ cm & $66$ piksel \\ \hline
        Tumpang tindih dua kamera pada segmen $7{,}20$ m & $2{,}20$ m \\ \hline
    \end{tabularx}
    \endgroup
\end{table}

Liputan melintang $3{,}53$~m melebihi lebar koridor $2{,}70$~m, sedangkan satu kamera tidak mencukupi segmen uji sepanjang $7{,}20$~m. Dua kamera karenanya menutup segmen tersebut dengan tumpang tindih $2{,}20$~m, yang dipakai untuk menyatukan keduanya ke satu kerangka acuan global.

Model lubang jarum hanya berlaku untuk lensa tanpa distorsi, sedangkan ELP mencantumkan sudut pandang horizontal $150^\circ$ untuk lensa ini \cite{elpGlobalShutterOG05B10}, jauh di atas $107{,}6^\circ$ menurut model tersebut. Lensa ini dengan demikian berdistorsi tong. Distorsi memperluas liputan tetapi menurunkan kepadatan piksel ke arah tepi citra, sehingga nilai pada Tabel~\ref{tab:liputan_kamera} hanya berlaku di sekitar sumbu optik. Bila lensa diasumsikan berproyeksi ekuidistan sebagai batas pesimistis, sisi penanda $12$~cm pada arah radial tinggal sekitar $41$ piksel di tepi koridor yang sejajar dengan kamera dan sekitar $23$ piksel di ujung segmen. Kepadatan piksel sebenarnya diukur melalui kalibrasi intrinsik pada Fase~2. Bila penanda di tepi liputan tidak terdeteksi andal, pilihan yang tersedia adalah memperbesar penanda, menaikkan ketinggian terbang agar jarak kamera ke penanda berkurang, atau menambah kamera ketiga.

Ukuran penanda ditetapkan dari syarat deteksi. Penanda dianggap terdeteksi andal bila sisinya mencakup sekurang-kurangnya $48$ piksel. Di sekitar sumbu optik, penanda $10$~cm ($55$ piksel) dan $12$~cm ($66$ piksel) sama-sama memenuhi syarat, tetapi ukuran $12$~cm dipilih untuk menyisakan margin terhadap penurunan kepadatan piksel di tepi citra dan mendekati $80$ piksel yang nyaman untuk wahana bergerak. Keandalan deteksi saat terbang dipastikan pada uji terbang tunggal sebelum komponen kawanan dibeli (Bab~IV).
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|c|>{\raggedright\arraybackslash}X|>{\centering\arraybackslash}p{1.35cm}|>{\raggedleft\arraybackslash}p{2.1cm}|>{\raggedleft\arraybackslash}p{2.8cm}|}
        ...
        11 & Kardus polos 60 $\times$ 40 $\times$ 40 cm sebagai rintangan\newline{\footnotesize\href{https://www.tokopedia.com/berlian90/dus-packing-polos-jumbo-60x40x40-cm-kardus-besar-kardus-packing-polos-box-jumbo-kondisi-baru-1730914591889655635}{tokopedia.com/berlian90}} & 10 unit & 34.700 & 347.000 \\ \hline
        ...
        \multicolumn{4}{|r|}{\textbf{Subtotal}} & \textbf{12.593.747} \\ \hline
    \end{tabularx}
    \endgroup
\end{table}

Pos sensor jarak terpilih memakai harga VL53L1X. Bila HC-SR04 yang terpilih, pos tersebut turun menjadi Rp212.800. Bila MTF-01 yang terpilih, tiga unit yang tersedia perlu dilengkapi tujuh unit, dan dengan harga listing tertinggi Rp1.565.000 per unit pos tersebut naik menjadi Rp10.955.000.
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|X|>{\raggedleft\arraybackslash}p{4.0cm}|}
        ...
        Fase 4: Uji Terbang Eksperimen & 12.593.747 \\ \hline
        Fase 5: Analisis Data dan Pelaporan & -- \\ \hline
        \textbf{Total} & \textbf{22.639.974} \\ \hline
    \end{tabularx}
    \endgroup
\end{table}
