...
\begin{figure}[htbp]
    ...
    \caption{Wahana uji dan penempatan sensor jarak. (a) Empat saluran propeler menyisakan jalur datar selebar $4$~cm di sumbu tengah; penanda $12$~cm dipasang bertiang di atasnya. (b) Dua sensor diagonal bersudut $\theta$ terhadap arah maju menghasilkan jarak lateral $d_l$ dan $d_r$ untuk estimasi $w_e$.}
...
\begin{equation}
    d_l = d_{\mathrm{raw},l}\sin\theta, \qquad d_r = d_{\mathrm{raw},r}\sin\theta
\end{equation}
dengan $d_{\mathrm{raw}}$ jarak terukur sepanjang berkas sensor dan $\theta$ sudut berkas terhadap arah maju. Lebar ruang bebas adalah
\begin{equation}
