...
Seluruh komunikasi data memakai pesan MAVLink di atas soket UDP pada jaringan Wi-Fi lokal \cite{caoComputationalIntelligenceAlgorithms2024, linLeaderFollowerUAV2026}. Jaringan dibentuk oleh satu \textit{router} khusus di area uji dan memuat dua jalur berikut.
\begin{enumerate}
...
Fase~3 dinyatakan lolos bila beban CPU dan latensi berada dalam batas aman. Bila terjadi tunda atau galat program, pekerjaan kembali ke penanaman logika.
